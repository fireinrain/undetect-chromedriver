...
public class UndetectedChromeDriver extends ChromeDriver{
    ...
    private boolean keepUserDataDir;
    ...
    public UndetectedChromeDriver(ChromeOptions chromeOptions,
        ...
        this.keepUserDataDir = keepUserDataDir;
    ...
    private void stealth() {
        ...
        try {
            InputStream in = this.getClass().getClassLoader().getResourceAsStream("stealth.min.js");
